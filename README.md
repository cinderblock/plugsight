...
The official Windows Device Manager has a fundamental UX problem: **every change refreshes the entire device tree**. You can never watch the list grow. You can never see what just disappeared. Tiny 8-pixel error overlay icons are nearly invisible. This project fixes all of that.
...
The built executable will be at `src-tauri/target/release/device-manager.exe`.
